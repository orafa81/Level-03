...
@section('content')
    <section class="bg-white py-8 antialiased dark:bg-white md:py-8">
        <div class="mx-auto max-w-screen-lg px-4 2xl:px-0">
            <nav class="mb-4 flex" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    <li class="inline-flex items-center">
                        <a href="#"
                            class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-primary-600 dark:text-gray-700 dark:hover:text-rose-600">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm font-medium text-gray-500 dark:text-gray-500 md:ms-2">Locador
                                page</span>
                        </div>
                    </li>
                </ol>
            </nav>
            <h2 class="mb-4 text-xl font-semibold text-gray-900 dark:text-gray-900 sm:text-2xl md:mb-6">Visão Geral</h2>
            {{-- <div
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-gray-500 dark:text-gray-500">Reviews</h3>
                    <span class="flex items-center text-2xl font-bold text-gray-900 dark:text-gray-900">16
                        <span
                            class="ms-2 inline-flex items-center rounded bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:bg-green-100 dark:text-green-800">
                    ...
                    <p class="mt-2 flex items-center text-sm text-gray-500 dark:text-gray-500 sm:text-base">
                        <svg class="me-1.5 h-4 w-4 text-gray-500 dark:text-gray-500" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                            viewBox="0 0 24 24">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-gray-500 dark:text-gray-500">Carros favoritos</h3>
                    <span class="flex items-center text-2xl font-bold text-gray-900 dark:text-gray-900">8
                        <span
                            class="ms-2 inline-flex items-center rounded bg-red-100 px-2.5 py-0.5 text-xs font-medium text-red-800 dark:bg-red-100 dark:text-red-800">
                            <svg class="-ms-1 me-1 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 24 24">
                ...
                <div>
                    ...
                    <h3 class="mb-2 text-gray-500 dark:text-gray-500">Produtos Retornados</h3>
                    <span class="flex items-center text-2xl font-bold text-gray-900 dark:text-gray-900">2
                        <span
                            class="ms-2 inline-flex items-center rounded bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:bg-green-100 dark:text-green-800">
                            <svg class="-ms-1 me-1 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 24 24">
            ...
            <div class="py-4 md:py-8 border-t dark:border-gray-200">
                <div class="mb-4 grid gap-4 sm:grid-cols-2 sm:gap-8 lg:gap-16">
                    <div class="space-y-4">
                        <div class="flex space-x-4">
                            ...
                            <div>
                                <span
                                    class="mb-2 inline-block rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-800 dark:bg-rose-100 dark:text-rose-800">
                                    Conta Locador </span>
                                <h2
                                    class="flex items-center text-xl font-bold leading-none text-gray-900 dark:text-gray-900 sm:text-2xl">
                                    {{ $locador->store_name }}</h2>
                            </div>
                        </div>
                        <dl class="">
                            <dt class="font-semibold text-gray-900 dark:text-gray-900">Enderesso de Email</dt>
                            <dd class="text-gray-500 dark:text-gray-500">{{ Auth::user()->email }}</dd>
                        </dl>

                        <dl>
                            <dt class="font-semibold text-gray-900 dark:text-gray-900">Favorite pick-up point</dt>
                            <dd class="flex items-center gap-1 text-gray-500 dark:text-gray-500">
                                ...
                                {{ $locador->road }} - {{ $locador->state }}, {{ $locador->number }}, {{ $locador->city }},
                                Brazil.
                            </dd>
                        </dl>
                    </div>
                    <div class="space-y-4">
                        <dl>
                            <dt class="mb-1 font-semibold text-gray-900 dark:text-gray-900">Payment Methods</dt>
                            <dd class="flex items-center space-x-4 text-gray-500 dark:text-gray-500">
                                <div
                                ...
                                <div>
                                    <div class="text-sm">
                                        <p class="mb-0.5 font-medium text-gray-900 dark:text-gray-900">Visa ending in 7658
                                        </p>
                                        <p class="font-normal text-gray-500 dark:text-gray-500">Expiry 10/2024</p>
                                    </div>
                                </div>
                            </dd>
                        </dl>
                ...
                <a href="{{ route('locador.edit', $locador->id) }}" data-modal-target="accountInformationModal2"
                    data-modal-toggle="accountInformationModal2"
                    class="inline-flex w-full items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-rose-700 dark:text-white dark:hover:bg-rose-800 dark:focus:outline-none dark:focus:ring-4  dark:focus:focus:ring-primary-300 sm:w-auto">
            ...
            @if (!($info && count($info) > 0))
                <div
                    class="rounded-lg flex items-center justify-center border border-gray-200 bg-gray-50 p-4 dark:border-gray-200 dark:bg-gray-50 md:p-8">
                    <div class=" max-w-screen-xl justify-center px-4 pt-10 pb-8 mx-auto">
                        <div class="mr-auto place-self-center lg:col-span-7">
                            <h1
                                class="max-w-2xl mx-auto mb-4 text-center text-4xl font-extrabold leading-none tracking-tight md:text-xl xl:text-2xl dark:text-gray-900">
                                Ainda não possui nenhum carro cadastrado</h1>
            ...
            @else
                <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-200 dark:bg-gray-50 md:p-8">
                    <h3 class="mb-4 text-xl font-semibold text-gray-900 dark:text-gray-900">Carros cadastrados</h3>
                    @foreach ($info as $item)
                        <div
                            class="flex flex-wrap items-center gap-y-4 border-b border-gray-200 pb-4 dark:border-gray-200 md:pb-5">
                            <dl class="w-1/2 sm:w-1/4 md:flex-1 lg:w-auto">
                                <dt class="text-base font-medium text-gray-500 dark:text-gray-500">Placa</dt>
                                <dd class="mt-1.5 text-base font-semibold text-gray-900 dark:text-gray-900">
                                    <a href="#" class="hover:underline">{{ $item->plate }}</a>
                                </dd>
                            </dl>

                            <dl class="w-1/2 sm:w-1/4 md:flex-1 lg:w-auto">
                                <dt class="text-base font-medium text-gray-500 dark:text-gray-500">Marca</dt>
                                <dd class="mt-1.5 text-base font-semibold text-gray-900 dark:text-gray-900">
                                    {{ $item->mark }}</dd>
                            </dl>

                            <dl class="w-1/2 sm:w-1/4 md:flex-1 lg:w-auto">
                                <dt class="text-base font-medium text-gray-500 dark:text-gray-500">Modelo</dt>
                                <dd class="mt-1.5 text-base font-semibold text-gray-900 dark:text-gray-900">
                                    {{ $item->model }}</dd>
                            </dl>

                            <dl class="w-1/2 sm:w-1/5 md:flex-1 lg:w-auto">
                                <dt class="text-base font-medium text-gray-500 dark:text-gray-500">Preço</dt>
                                <dd class="mt-1.5 text-base font-semibold text-gray-900 dark:text-gray-900">
                                    ${{ $item->price }}</dd>
                            </dl>

                            {{-- <dl class="w-1/2 sm:w-1/4 sm:flex-1 lg:w-auto">
                            <dt class="text-base font-medium text-gray-500 dark:text-gray-500">Status:</dt>
                            <dd
                                class="me-2 mt-1.5 inline-flex shrink-0 items-center rounded bg-yellow-100 px-2.5 py-0.5 text-xs font-medium text-yellow-800 dark:bg-yellow-100 dark:text-yellow-800">
                            ...
                            <div class=" w-full sm:flex sm:w-32 sm:items-center sm:justify-end sm:gap-4">
                                <button id="actionsMenuDropdownModal" data-dropdown-toggle="dropdownOrderModal10"
                                    type="button"
                                    class=" actionsMenuDropdownModal flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-200 dark:bg-white dark:text-gray-900 dark:hover:bg-gray-100 dark:hover:text-rose-700 dark:focus:ring-gray-100 md:w-auto">
                                    Actions
                                ...
                                <div id="dropdownOrderModal"
                                    class=" dropdownOrderModal z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-white shadow dark:bg-white"
                                    data-popper-reference-hidden="" data-popper-escaped=""
                                    data-popper-placement="bottom">
                                    <ul class="p-2 text-left text-sm font-medium text-gray-500 dark:text-gray-500"
                                        aria-labelledby="actionsMenuDropdown10">
                                        <li>
                                            <a href="{{ route('product', $item->id) }}"
                                                class="group inline-flex w-full items-center rounded-md px-3 py-2 text-sm text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-500 dark:hover:bg-gray-100 dark:hover:text-gray-900">
                                                <svg class="me-1.5 h-4 w-4 text-gray-400 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-gray-900"
                                        ...
                                        <li>
                                            <a href="{{ route('destroy.car', $item->id) }}"
                                                data-modal-target="deleteOrderModal" data-modal-toggle="deleteOrderModal"
                                                class="group inline-flex w-full items-center rounded-md px-3 py-2 text-sm text-red-600 hover:bg-gray-100 dark:text-red-600 dark:hover:bg-gray-100">
                            ...
                            <script>
                                document.addEventListener("DOMContentLoaded", function() {
                                    ...
                                    ".actionsMenuDropdownModal"); // Seleciona todos os botões
                                    const dropdowns = document.querySelectorAll(".dropdownOrderModal"); // Seleciona todos os dropdowns

                                    actionButtons.forEach(button => {
                                        button.addEventListener("click", function() {
                                            const dropdown = this.nextElementSibling; // Encontra o dropdown associado

                                            if (dropdown.classList.contains("hidden")) {
                                                // Fecha todos os outros dropdowns antes de abrir o atual
                                                dropdowns.forEach(drop => {
                                                    if (drop !== dropdown) {
                                                        drop.classList.remove("opacity-100", "translate-y-0");
                                                        drop.classList.add("opacity-0", "translate-y-[-10px]");
                                                ...
                                                // Abre o dropdown associado ao botão clicado
                                                dropdown.classList.remove("hidden");
                                                dropdown.classList.add("opacity-0", "absolute", "translate-y-[90px]");
                                                setTimeout(() => {
                                                    dropdown.classList.remove("opacity-0", "translate-y-[-10px]");
                                                    dropdown.classList.add("opacity-100", "translate-y-0");
                                                }, 10);
                                            } else {
                                                // Fecha o dropdown clicado
                ...
                <a href="{{ route('create.car') }}"
                    class="inline-flex w-full mt-5 items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-rose-700 dark:text-white dark:hover:bg-rose-800 dark:focus:outline-none dark:focus:ring-4  dark:focus:focus:ring-primary-300 sm:w-auto">
                    <svg class="-ms-0.5 me-1.5 h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                        width="24" height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m14.304 4.844 2.852 2.852M7 7H4a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1v-4.5m2.409-9.91a2.017 2.017 0 0 1 0 2.853l-6.844 6.844L8 14l.713-3.565 6.844-6.844a2.015 2.015 0 0 1 2.852 0Z">
            ...
            <div class="max-h-auto relative max-h-full w-full max-w-lg p-4">
                ...
                <div class="relative rounded-lg bg-white shadow dark:bg-gray-800">
                    ...
                    <div
                        ...
                        <button type="button"
                            class="ms-auto inline-flex h-8 w-8 items-center justify-center rounded-lg bg-transparent text-sm text-gray-400 hover:bg-gray-200 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-rose-600"
                            data-modal-toggle="accountInformationModal2">
                    ...
                    <form class="p-4 md:p-5">
                        <div class="mb-5 grid grid-cols-1 gap-4 sm:grid-cols-2">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div id="dropdown_phone_input_billing_modal"
                                        ...
                                        <ul class="p-2 text-sm font-medium text-gray-700 dark:text-gray-200"
                                            ...
                                            <li>
                                                <button type="button"
                                                    class="inline-flex w-full rounded-md px-3 py-2 text-sm text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-500 dark:hover:bg-gray-600 dark:hover:text-rose-600"
                                                    role="menuitem">
                            ...
                            <div class="col-span-2">
                                <label for="address_billing_modal"
                                    class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Delivery
                                    Address* </label>
                        ...
                        <div class="border-t border-gray-200 pt-4 dark:border-gray-700 md:pt-5">
                            ...
                            <button type="button" data-modal-toggle="accountInformationModal2"
                                class="me-2 rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-500 dark:hover:bg-gray-700 dark:hover:text-rose-600 dark:focus:ring-gray-700">Cancel</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div id="deleteOrderModal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative h-full w-full max-w-md p-4 md:h-auto">
                ...
                <div class="relative rounded-lg bg-white p-4 text-center shadow dark:bg-gray-800 sm:p-5">
                    <button type="button"
                        class="absolute right-2.5 top-2.5 ml-auto inline-flex items-center rounded-lg bg-transparent p-1.5 text-sm text-gray-400 hover:bg-gray-200 hover:text-gray-900 dark:hover:bg-gray-600 dark:hover:text-rose-600"
                    ...
                    <div
                        ...
                        <svg class="h-8 w-8 text-gray-500 dark:text-gray-500" aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                            viewBox="0 0 24 24">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M5 7h14m-9 3v8m4-8v8M10 3h4a1 1 0 0 1 1 1v3H9V4a1 1 0 0 1 1-1ZM6 7h12v13a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V7Z" />
                    ...
                    <p class="mb-3.5 text-gray-900 dark:text-white"><a href="#"
                        ...
                        are
                        you sure you want to delete this order from your account?</p>
