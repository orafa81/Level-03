...
@section('content')
    ...
    @if (session('fail'))
        <div id="alert_msg"
            class="flex fixed top-10 right-4 items-center p-4 mb-4 text-green-800 rounded-lg bg-green-50 dark:bg-red-50 dark:text-red-800"
            role="alert">
            <svg class="shrink-0 w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                viewBox="0 0 20 20">
                <path
            ...
            <button type="button"
                class="ms-auto -mx-1.5 -my-1.5 bg-red-50 text-red-500 rounded-lg focus:ring-2 focus:ring-red-400 p-1.5 hover:bg-red-200 inline-flex items-center justify-center h-8 w-8 dark:bg-red-50 dark:text-red-500 dark:hover:bg-red-200 dark:focus:ring-2 dark:focus:ring-red-400"
                id="btnAlert" aria-label="Close">
                <span class="sr-only">Close</span>
                <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 14 14">
    ...
    {{-- CARDS PRODUCTS --}}
    <section class="bg-gray-50 py-8 antialiased dark:bg-white md:py-12">
                    ...
                    <nav class="flex" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            <li class="inline-flex items-center">
                                <a href="{{ route('home') }}"
                                    class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-primary-600 dark:text-gray-900 dark:hover:text-rose-600">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="#"
                                        class="ms-1 text-sm font-medium text-gray-700 hover:text-primary-600 dark:text-gray-900 md:ms-2">Products</a>
                                </div>
                            </li>
                        </ol>
                    </nav>
                    <h2 class="mt-3 text-xl font-semibold text-white dark:text-gray-900 sm:text-2xl">Electronics</h2>
                </div>
                <div class="flex items-center space-x-4">
                    <button data-modal-toggle="filterModal" data-modal-target="filterModal" type="button"
                        class="flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-400 dark:hover:border-rose-600 dark:bg-white dark:text-gray-900 dark:hover:bg-white dark:hover:text-rose-600 dark:focus:ring-rose-700 sm:w-auto">
                    ...
                    <div
                        ...
                        <div class="h-56 w-full">
                            <a href="{{ route('product', $item->id) }}">
                                <img class="mx-auto h-full dark:hidden" src="../../../imagens/kwid.png" alt="" />
