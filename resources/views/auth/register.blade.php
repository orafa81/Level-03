                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <a href="{{ route('auth.google.redirect') }}"
                                class="btn bg-blue-100 p-3 shadow-sm border rounded-md text-blue-900">
                                Login with Google
                            </a>
        ...
        <div class="flex w-1/2 justify-center items-center bg-white">
            <form class="bg-white" method="POST" action="{{ route('register') }}">
                ...
                <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                    ...
                    <input class="pl-2 outline-none border-none @error('name') is-invalid @enderror"
                        value="{{ old('name') }}" required autocomplete="name" autofocus type="text" name="name"
                ...
                <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                    ...
                    <input class="pl-2 outline-none border-none" id="password-confirm" type="password"
                        name="password_confirmation" required autocomplete="new-password"
                ...
                <button type="submit"
                    class="block w-full bg-rose-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">{{ __('Register') }}</button>
                <a href="{{route('login')}}" class="text-sm ml-2 hover:text-rose-500 cursor-pointer">Acessar minha conta?</a>
            </form>
        </div>
    </div>
@endsection
